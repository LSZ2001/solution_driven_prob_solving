...
jsPsych.plugins['html-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<div class="jspsych-html-slider-response-container" style="position:fixed; top: 70%; left: 20%; ';
    ...
    // add submit button
    html += '<button style="position: fixed; top: 89%; left: 49.2%;" id="jspsych-html-slider-response-next" class="jspsych-btn" '+ (trial.require_movement ? "disabled" : "") + '>'+trial.button_label+'</button>';
